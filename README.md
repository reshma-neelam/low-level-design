...
Multi-player : 2 humans can play
Single-player : 1 human and 1 Bot player

Below Winning strategies are implemented and are pluggable:
Row, Column, Diagonals

More winning strategies can be implemented and plugged.
By default, all 3 are added.
